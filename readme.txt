...
- Move it around, resize it, rotate it, flip it, step through images in a folder
...
- Scroll Wheel to Zoom - Hold SHIFT to zoom faster, Hold CTRL to zoom based on center (doesn't look very smooth at the moment though)
...
- P to reload config.txt

Notes
--------
- If you need to reset your configuration, simply delete config.txt and open an image. A new config.txt file will be created.